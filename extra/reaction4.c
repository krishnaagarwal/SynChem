...
Tsd_t *unenctsd;
  ...
  if (destination < 0 || destination > React_NumSchemas_Get () + 1 ||
...
#ifdef _ENCRYPT_
unenctsd = Tsd_Decrypt (React_Goal_Get (SReactions[destination]), 0, source);
Tsd_Destroy (React_Goal_Get (SReactions[destination]);
React_Goal_Put (SReactions[destination], Tsd_Encrypt (unenctsd, 0, destination));
Tsd_Destroy (unenctsd);
#endif /* _ENCRYPT_ */
...
#ifdef _ENCRYPT_
unenctsd = Tsd_Decrypt (React_Subgoal_Get (SReactions[destination]), 1, source);
Tsd_Destroy (React_Subgoal_Get (SReactions[destination]);
React_Subgoal_Put (SReactions[destination], Tsd_Encrypt (unenctsd, 1, destination));
Tsd_Destroy (unenctsd);
#endif /* _ENCRYPT_ */
  ...
  React_TxtRec_Name_Put (React_Text_Get (SReactions[destination]),
    String_Copy_Encrypted (React_TxtRec_Name_Get (React_Text_Get (SReactions[source])), 0, source, destination));
#else /* NOT _ENCRYPT_ */
  React_TxtRec_Name_Put (React_Text_Get (SReactions[destination]),
  ...
  for (i = 0; i < React_TxtHd_NumComments_Get (React_TxtRec_Head_Get (
    ...
    String_Copy_Encrypted (React_TxtRec_Comment_Get (React_Text_Get (SReactions[source]), i), i, source, destination));
#else /* NOT _ENCRYPT_ */
    React_TxtRec_Comment_Put (React_Text_Get (SReactions[destination]), i,
  ...
  for (i = 0; i < React_TxtHd_NumReferences_Get (React_TxtRec_Head_Get (
    ...
    String_Copy_Encrypted (React_TxtRec_Reference_Get (React_Text_Get (SReactions[source]), i), i, source, destination));
#else /* NOT _ENCRYPT_ */
    React_TxtRec_Reference_Put (React_Text_Get (SReactions[destination]), i,
  ...
  for (i = 0; i < React_Head_NumTests_Get (
    ...
    React_TxtRec_Reason_Put (React_Text_Get (SReactions[destination]), i,
      String_Copy_Encrypted (React_TxtRec_Reason_Get (React_Text_Get (SReactions[source]), i), i, source, destination));
    React_TxtRec_Chemist_Put (React_Text_Get (SReactions[destination]), i,
      String_Copy_Encrypted (React_TxtRec_Chemist_Get (React_Text_Get (SReactions[source]), i), i, source, destination));
#else /* NOT _ENCRYPT_ */
    React_TxtRec_Reason_Put (React_Text_Get (SReactions[destination]), i,
...
#ifdef _ENCRYPT_
  encrypted = String_Encrypt (create_string, 0, destination);
  String_Destroy (create_string);
  React_TxtRec_Reference_Put (stxt, 0, encrypted);
#else /* NOT _ENCRYPT_ */
...
String_t unencrypted;
...
#ifdef _ENCRYPT_
  goal = Tsd_Decrypt (React_Goal_Get (schema), 0, source);
  subgoal = Tsd_Decrypt (React_Subgoal_Get (schema), 1, source);
#else /* NOT _ENCRYPT_ */
...
#ifdef _ENCRYPT_
  unencrypted = String_Decrypt (React_TxtRec_Name_Get (text), 0, source);
  Sprintf (line, unencrypted);
  ...
  for (i = 0; i < React_TxtHd_NumComments_Get (txt_head); i++)
    ...
    strcat (buffer, "\t");
#ifdef _ENCRYPT_
    unencrypted = String_Decrypt (React_TxtRec_Comment_Get (text, i), i, source);
    Sprintf (line, unencrypted);
    String_Destroy (unencrypted);
#else /* NOT _ENCRYPT_ */
  ...
  for (i = 0; i < React_TxtHd_NumReferences_Get (txt_head); i++)
    ...
    strcat (buffer, "\t");
#ifdef _ENCRYPT_
    unencrypted = String_Decrypt (React_TxtRec_Reference_Get (text, i), i, source);
    Sprintf (line, unencrypted);
    String_Destroy (unencrypted);
#else /* NOT _ENCRYPT_ */
  ...
  for (i = 0; i < React_Head_NumTests_Get (sch_head); i++)
    ...
    strcat (buffer, line);
    strcat (buffer, "\t\t");
    unencrypted = String_Decrypt (React_TxtRec_Reason_Get (text, i), i, source);
    Sprintf (line, unencrypted);
    String_Destroy (unencrypted);
    strcat (buffer, line);
    strcat (buffer, "\t\t");
    unencrypted = String_Decrypt (React_TxtRec_Chemist_Get (text, i), i, source);
    Sprintf (line, unencrypted);
    String_Destroy (unencrypted);
    strcat (buffer, line);
    }
...
/* destroy decrypted goal and subgoal */
  Tsd_Destroy (goal);
  Tsd_Destroy (subgoal);
#else /* NOT _ENCRYPT_ */
    strcat (buffer, line);
...
#else /* NOT _MIND_MEM_ */
printf("dest=%d nsch=%d SR[dest]=%p\n",destination, React_NumSchemas_Get(), SReactions[destination]);
  if (destination < 0 || destination > React_NumSchemas_Get () + 1 ||
    SReactions[destination] != NULL) return (FALSE);
...
/*return;*/
  ...
  Sgets (line, &buf);
#ifdef _ENCRYPT_
  unencrypted = String_Create (line, 0);
  React_TxtRec_Name_Put (text, String_Encrypt (unencrypted, 0, destination));
  String_Destroy (unencrypted);
#else /* NOT _ENCRYPT_ */
...
/*return;*/
  ...
  for (i = 0; i < React_TxtHd_NumComments_Get (txt_head); i++)
    ...
    Sgets (line, &buf);
#ifdef _ENCRYPT_
    unencrypted = String_Create (line + 1, 0);
    React_TxtRec_Comment_Put (text, i, String_Encrypt (unencrypted, i, destination));
    String_Destroy (unencrypted);
#else /* NOT _ENCRYPT_ */
...
#ifdef _ENCRYPT_
    unencrypted = String_Create (line + 1, 0);
    React_TxtRec_Reference_Put (text, i, String_Encrypt (unencrypted, i, destination));
    String_Destroy (unencrypted);
#else /* NOT _ENCRYPT_ */
...
/*return;*/
  Sgets (line, &buf);
printf("line=\"%s\"\n",line);
  for (i = 0; line[8 * i] != '\0'; i++)
{
sscanf (line + 8 * i, " %03d:%03d", inputs + 2 * i, inputs + 2 * i + 1);
printf("inputs[%d]=%d inputs[%d]=%d\n",2*i,inputs[2*i],2*i+1,inputs[2*i+1]);
}
#else /* NOT _DEBUG_ */
  Sgets (line, &buf);
  for (i = 0; line[8 * i] != '\0'; i++)
...
#ifdef _ENCRYPT_
  React_Goal_Put (SReactions[destination], Tsd_Encrypt (goal, 0, destination));
  Tsd_Destroy (goal);
#endif /* _ENCRYPT_ */
...
#ifdef _ENCRYPT_
  React_Subgoal_Put (SReactions[destination], Tsd_Encrypt (subgoal, 1, destination));
  Tsd_Destroy (subgoal);
#endif /* _ENCRYPT_ */
...
#ifdef _ENCRYPT_
    Sgets (line, &buf);
    unencrypted = String_Create (line + 2, 0);
    React_TxtRec_Reason_Put (text, testnum, String_Encrypt (unencrypted, testnum, destination));
    String_Destroy (unencrypted);

    Sgets (line, &buf);
    unencrypted = String_Create (line + 2, 0);
    React_TxtRec_Chemist_Put (text, testnum, String_Encrypt (unencrypted, testnum, destination));
    String_Destroy (unencrypted);
#else /* NOT _ENCRYPT_ */
    Sgets (line, &buf);
...
void Sgets (char *dest, char **src)
{
  ...
  for (d = dest; **src != '\r' /* compensate for antiquated DOS ASCII format */ && **src != '\n';) *d++ = *(*src)++;
  *d = '\0';
  if (**src == '\r') (*src)++;
  (*src)++;
