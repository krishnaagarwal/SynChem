...
/* Use confidence as a tie-breaker among otherwise identical subgoal merits */
    Array_1d16_Put (&merit_table, i, 101 * PstSubg_Merit_Main_Get (subgoal_p) +
      (S16_t) Array_1d16_Get (&conf_table, i));
...
#ifdef _DEBUG_
  printf ("Subgoal ordering:\n");
  for (i = 1; i <= num_subgoals; ++i) printf ("\tsubgoal %5d: merit=%3d confidence=%3d\n",
    i, (S16_t) Array_1d16_Get (&merit_table, i) / 101, (S16_t) Array_1d16_Get (&merit_table, i) % 101);
#endif
