...
#ifdef _DEBUG_
printf("before Tsd_Decrypt (g)\n");
#endif
  goal_tsd_p = Tsd_Decrypt (React_Goal_Get (react_p), 0, schema);
#ifdef _DEBUG_
printf("after Tsd_Decrypt (g)\n");
Tsd_Dump(goal_tsd_p,&GStdErr);
#endif
  goal_xtr_p = Tsd2Xtr (goal_tsd_p);
  Xtr_Rings_Set (goal_xtr_p);
#ifdef _DEBUG_
printf("goal xtr created\n");
#endif
  goal_pattern_size = React_Head_GoalSize_Get (head_p);
  goal_num_atoms = Xtr_NumAtoms_Get (goal_xtr_p);
#ifdef _DEBUG_
printf("before Tsd_Decrypt(subg)\n");
#endif
  subgoal_tsd_p = Tsd_Decrypt (React_Subgoal_Get (react_p), 1, schema);
#ifdef _DEBUG_
printf("after Tsd_Decrypt (subg)\n");
Tsd_Dump(subgoal_tsd_p,&GStdErr);
#endif
  subgoal_xtr_p = Tsd2Xtr (subgoal_tsd_p);
#ifdef _DEBUG_
printf("subgoal xtr created\n");
#endif
...
Tsd_Destroy (goal_tsd_p);
Tsd_Destroy (subgoal_tsd_p);
    return;
    }
...
#ifdef _DEBUG_
printf("before Schema_Active_Find\n");
#endif
  SSchema_Active_Find (goal_xtr_p, subgoal_xtr_p, goal_pattern_size, 
    &goal_active_atoms, &goal_active_bonds); 
    
#ifdef _DEBUG_
printf("after Schema_Active_Find\n");
#endif
...
#ifdef _DEBUG_
printf("Match_Piece_t allocated\n");
#endif
