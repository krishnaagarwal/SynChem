...
/****************************************************************************
*
*  Function Name:                 Tsd_Encrypt
*
*    This routine encrypts or decrypts a tsd.
*
*  Used to be:
*
*  Implicit Inputs:
  ...
  )
{
  ...
  if (tsd_p == NULL) return (NULL);
  copy = Tsd_Copy (tsd_p);
  Mem_Encrypt (Tsd_AtomHandle_Get (copy), 50 * offset, recnum, Tsd_NumAtoms_Get (copy) *TSDROWSIZE);
