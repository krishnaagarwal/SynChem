  ...
  )
{
  ...
  Mem_Encrypt (String_Value_Get (copy), 25 * offset, recnum, String_Length_Get (copy));
  ...
  )
{
  ...
  dest_copy = String_Encrypt (source, offset, dest_recnum);
...
/****************************************************************************
*
*  Function Name:                 String_Encrypt_and_Replace
*
