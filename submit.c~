...
U32_t cmpinx;
printf("kka:entering Submission_Execute\n");
...
printf("kka:exiting Submission_Execute\n");
  return;
}
  ...
  ) 
{
  ...
  SubmitCB_t    *submitcb_p;
  Rcb_t          sbmt_rcb;                   /* Temp Rcb from submit form */
printf("kka:entering Submit_SubmitPB_CB\n");
  submitcb_p = (SubmitCB_t *) client_data;
  pcb_p = Pst_ControlHandle_Get ();
...
printf("kka:exiting Submit_SubmitPB_CB\n");
  return;
}
