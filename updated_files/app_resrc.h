...
#define SAR_FONTNAME_FDFLT_LRG\
  "-*-clean-medium-r-normal-*-14-*-*-*-*-70-*"

#define SAR_FONTNAME_FDFLT_NML\
  "-*-clean-medium-r-normal-*-12-*-*-*-*-60-*"

#define SAR_FONTNAME_FDFLT_SML\
  "-*-clean-medium-r-normal-*-10-*-*-*-*-50-*"

#define SAR_FONTNAME_FDFLT_MIN\
  "-*-clean-medium-r-normal-*-6-*-*-*-*-40-*"
*/
#define SAR_FONTNAME_FDFLT_LRG\
...
#define SAR_FONTTAG_RXNNAM_NML    SAR_FONTNAME_RXNLBL_NML//kka:SAR_FONTTAG_ATM_LRG
#define SAR_FONTTAG_RXNNAM_SML    SAR_FONTNAME_RXNLBL_SML//kka:SAR_FONTTAG_ATM_SML
#define SAR_FONTTAG_RXNVAL_NML    SAR_FONTNAME_RXNLBL_NML//kka:SAR_FONTTAG_ATM_LRG
#define SAR_FONTTAG_RXNVAL_SML    SAR_FONTNAME_RXNLBL_SML//kka:SAR_FONTTAG_ATM_SML
